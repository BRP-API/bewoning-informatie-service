...
namespace Bewoning.Informatie.Service.Helpers
{
    public static class AdellijkeTitelPredicaatHelpers
    {
        ...
        public static string MapNaarAdellijkeTitel(this Waardetabel waardetabel, Waardetabel? geslacht)
        {
        ...
        public static string MapNaarPredicaat(this Waardetabel waardetabel, Waardetabel? geslacht)
        {
            if (waardetabel == null) return string.Empty;
